...
const LocationCard = ({
  ...
  return (
    ...
    >
      ...
      <h3 className="relative z-10 text-2xl font-serif text-white tracking-wide group-hover:text-amber-50 transition-colors">
        {title}
      </h3>

      <p className="relative z-10 whitespace-pre-line text-amber-100/70 text-lg group-hover:text-amber-100/90 transition-colors">
        {content}
      </p>
    </motion.div>
  );
